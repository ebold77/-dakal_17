...
class BuySellOutLine(models.Model):
    _name = "buy.sell.in.line"
    _description = "Buy and Sell In Line"
    ...
    pricelist_discount = fields.Float(string='PriceList Discount', required=True, digits='Product Price')
    ...
    def onchange_pricelist_discount(self):
        if self.product_qty > 0:
            ...
            self.list_price_total = self.list_price_total = self.discount_total
