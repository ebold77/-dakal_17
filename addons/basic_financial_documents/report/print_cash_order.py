...
class PrintCashIncomeOrder(models.AbstractModel):
    _name = "report.basic_financial_documents.print_cash_income_order"
    _description = 'Print Cash Income Order'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report = self.env['ir.actions.report'].search([('report_name', '=', 'basic_financial_documents.print_cash_income_order')])
        verbose_total_dict = {}
        amounts = {}
        currency = {}
        signature_lines = {}
...
class PrintCashExpenseOrder(models.AbstractModel):
    _name = "report.basic_financial_documents.print_cash_expense_order"
    _description = 'Print Cash Expense Order'
