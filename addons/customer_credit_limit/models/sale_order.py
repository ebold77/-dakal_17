    ...
    def action_confirm(self):
        ...
        if partner_id.credit_check:
            ...
            if partner_id.credit_blocking <= total_amount and not existing_move:
                ...
                if self.amount_due < partner_id.credit_blocking:
                    potential_sale = partner_id.credit_blocking - self.amount_due
                    raise AccessDenied(_('Customer credit limit exceeded. Potential sales : %s'%(potential_sale)))
